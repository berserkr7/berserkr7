...
Привет! Ниже представлены выполненные мною проекты. Каждый проект кликабелен, также каждый проект имеет ссылку на Colab, чтобы тебе было удобнее взаимодействовать с кодом.
...
<p align="center"> <b>Задачи SQL + Оконные функции</b> </p align="center">
