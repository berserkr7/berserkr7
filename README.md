...
<div id='header' align='center'>
  ...
  <h2><a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=500&size=33&pause=1000&color=FF671E&repeat=false&width=800&lines=&nbsp+&nbsp+&nbsp+&nbsp+Machine+Learning+Engineer" alt="Typing SVG" /></a></h2>
</div>
...
![Mlxtend](https://img.shields.io/badge/Mlxtend-brightgreen?style=for-the-badge&)
...
![seaborn](https://img.shields.io/badge/seaborn-brightgreen?style=for-the-badge&)
...
<a href="https://github.com/samoylenko23/lifecycle-pipeline-models"><img src='https://img.shields.io/badge/К репозиторию-&#x21A9-blue'></a>

---


<h2><p align="center"> FastAPI Deployment Prodaction Model </p></h2>


Демонстрация написания pipeline обучения модели, с Feature Engineering и отбором признаков, создание микросервиса на FastAPI для работы с ML, мониторинг ML моделей (Prometheus и Grafana), выведенных в продакшн, а также контейнеризация написанного сервиса для работы в продакшн.
...
<a href="https://github.com/samoylenko23/fastapi_prodaction_deployment"><img src='https://img.shields.io/badge/К репозиторию-&#x21A9-blue'></a>

---


<h2><p align="center"> Simple FastAPI app with ML</p></h2>


Демонстрация простого ML сервиса на FastAPI для предсказания оттока клиентов.
...
<a href="https://github.com/samoylenko23/ML-FastAPI"><img src='https://img.shields.io/badge/К репозиторию-&#x21A9-blue'></a>
...
<h2><p align="center">Задачи SQL + Оконные функции</p></h2>
