...
<h2><p align="center"> Проекты Data Science. Классический Machine Learning </p></h2>
...
| Проект       | Описание                | Статус |
| ------------- |:------------------:| -----:|
| 01. Классификация Cats and Dogs | Используя Convolution Neural Network построить классификатор, который будет корректно классифицировать кошек и собак    | Завершен |
...
| 04. Реализация CNN LeNet     | Реализация алгоритма сверточной нейронной сети LeNet  | Завершен |
